...
public class BJ16236Correct {
    ...
    static int eatCnt = 0; // 상어가 물고기 먹은 횟수
    static int moveCnt = 0; // 상어가 이동한 횟수
