...
//                System.out.print(totalMoney[endCity]);
//            }
//        }
//        br.close();
//    }
...
//        }
//
//        if (cycleNodeList.isEmpty()) return false;
//
...
//            update = false;
//            for (int j = 0; j < N; j++) {
//                if (cycleNodeList.contains(j) || totalMoney[j] == INF) continue;
//                for (City city : a.get(j)) {
